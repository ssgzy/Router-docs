...
description: How to report bugs, request features, and reach AI Router support channels.
---
...
Open an issue on the source repository: [AI Router on GitHub](https://github.com/ssgzy/Router-new-api).
...
<Steps>
  ...
  <Step>Make sure you are running an up-to-date version of AI Router.</Step>

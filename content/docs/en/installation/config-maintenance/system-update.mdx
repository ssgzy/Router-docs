...
This document provides methods and best practices for updating the Code Router system to ensure a smooth upgrade to the latest version.
...
If you have deployed Code Router using a single Docker container, you can update by following these steps:
...
2.  Find the Code Router application and click the **Upgrade** button
...
2.  Find the Code Router container, click **More** -> **Recreate**
...
If you have deployed Code Router by compiling from source code, the update steps are as follows:

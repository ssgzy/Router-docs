...
This document provides a graphical tutorial for deploying Code Router using the 1Panel panel.
...
## Step 2: Install Code Router

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the Code Router application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure Code Router application parameters on the installation page:
</Callout>

- **Name**: The name of the Code Router application to be created
- **Version**: Select the version of Code Router
- **Port**: The service port for the Code Router application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the Code Router application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the Code Router application
...
## Step 4: Access Code Router

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the Code Router WebUI page
...
2. Find the Code Router application, click the **Upgrade** button
...
- [GitHub Repository](https://github.com/ssgzy/Router-new-api)
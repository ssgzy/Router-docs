...
description: Connect AI Router to popular AI apps and tools using one API key and one base URL.
---
...
<Cards>
  ...
  <Card
    icon={<Settings />}
    title="CC Switch"
    description="One-click fill from the AI Router token page; configure Claude, Codex, or Gemini with main and variant models in the popup."
  ...
  <Card
    icon={<Bot />}
    title="DeepChat"
    description="An open-source, cross-platform multi-model AI client with one-click AI Router provider import via DeepLink."
  ...
  <Card
    icon={<Bot />}
    title="OpenClaw"
    description="A self-hosted AI assistant platform — install OpenClaw, connect to AI Router, and manage agents across Feishu, Discord, Slack, and more."

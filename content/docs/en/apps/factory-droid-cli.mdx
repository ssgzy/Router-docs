...
description: Factory Droid CLI setup guide — install and configure this AI software engineering agent with Code Router. Supports end-to-end development from planning to testing.
---
...
<Callout type="info" title="Modify Environment Variables">
  ```powershell
  iex (irm 'https://raw.githubusercontent.com/ssgzy/Router-new-api-docs/refs/heads/main/helper/factory-cli-setup.ps1')
  ```
</Callout>
...
<Callout type="info" title="One-click Configuration File Modification">
  ```bash
  curl -fsSL https://raw.githubusercontent.com/ssgzy/Router-new-api-docs/refs/heads/main/helper/factory-cli-setup.sh | bash
  ```
</Callout>

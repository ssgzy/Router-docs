...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to AI Router for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the AI Router console, you can add
...
### Import Configuration from AI Router Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the AI Router console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the AI Router configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | AI Router                                  |
| Access Token        | AI Router Key                              |
| AI Router Endpoint     | AI Router Deployment Address (without /v1) |

...
Code Router now supports integration with popular analytics platforms to help you track user behavior and website performance:
...
environment:
  ...
  - UMAMI_SCRIPT_URL=https://your-umami-instance.example/script.js
```
...
export UMAMI_SCRIPT_URL=https://your-umami-instance.example/script.js  # Optional
```
...
docker exec code-router env | grep -E "GOOGLE_ANALYTICS|UMAMI"
```

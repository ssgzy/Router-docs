---
title: Pricing
description: Understand how Code Router displays model pricing, quotas, and usage-based billing
---

Code Router is an OpenAI-compatible AI gateway. The Pricing page shows the billing rate for each available model so you can estimate how much quota a request will consume before you call it.
...
Code Router bills on a usage basis, measured in **quota** units. The conceptual model is the same as any OpenAI-compatible gateway:

...
A token is the only secret you need to call AI Router. Point your OpenAI-compatible client at the gateway base URL and pass the token as the API key:

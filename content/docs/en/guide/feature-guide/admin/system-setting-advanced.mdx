...
Ratio settings are the core configuration of the AI Router billing system. By setting different Ratios, you can flexibly control the billing standards for various models and user groups.

### Ratio System Overview

AI Router uses a three-tier Ratio system to calculate user Quota consumption:
...
In the AI Router system, Ratios are key parameters for calculating Quota consumption. Quota is the internal billing unit of the system, and all API calls are ultimately converted into Quota points for deduction.
...
#### Audio Models (Special handling, automatically processed internally by AI Router)
...
AI Router employs a dual billing mechanism of pre-consumption and post-consumption:

---
title: API Tokens
description: Create and manage API tokens to call AI Router with one OpenAI-compatible key and base URL.
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Steps, Step } from 'fumadocs-ui/components/steps';

API tokens are the credentials your applications use to call AI Router. Each token is a single key that works against one OpenAI-compatible base URL, so you can route to many model providers without juggling per-provider keys. On this page you can view, create, edit, and revoke your tokens.
...
AI Router exposes an OpenAI-compatible API, so any OpenAI SDK or HTTP client works once you point it at the AI Router base URL and pass your token as a Bearer credential.
...
| Connection error | Wrong base URL — confirm you are using `https://ai.sammier.com/v1`. |

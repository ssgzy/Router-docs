...
AI Router provides quick access to several AI chat applications, making them convenient for testing or use.
...
<Callout type="warn">
  ...
  AI Router; manual entry is required.
</Callout>
...
<Callout type="info">
  Supports one-click configuration import from AI Router
</Callout>

## AMA 问天

<Callout type="info">
  AMA 问天 is an intelligent Q&A assistant provided by AI Router, supporting

...
description: How Code Router uses model, completion, and group ratios to convert API usage into quota consumption.
---
...
#### Audio models (handled automatically by Code Router)

---
title: Claude Code
description: Claude Code 設定ガイド — Anthropic のターミナルベースのコーディングエージェントを Code Router で利用。コード理解、マルチファイル編集、IDE統合に対応。
---
...
```powershell
iex (irm 'https://raw.githubusercontent.com/ssgzy/Router-new-api-docs/refs/heads/main/helper/claude-cli-setup.ps1')
```
...
<Callout type="info" title="ワンクリックでClaude Codeの環境変数を設定">
  ...
  ```bash
  curl -fsSL https://raw.githubusercontent.com/ssgzy/Router-new-api-docs/refs/heads/main/helper/claude-cli-setup.sh | bash
  ```
</Callout>
